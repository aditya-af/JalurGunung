...
public class MerbabuJalur extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // addGoogleMap();
        ...
        LatLng a = new LatLng(-7.483972222222,110.45125);
        MarkerOptions markerA = new MarkerOptions();
        markerA.position(a);
        markerA.title("Basecamp");
        markerA.snippet("-7.483972222222,110.45125");
        markerA.icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_GREEN));
        myMap.addMarker(markerA);
        
        LatLng b = new LatLng(-7.473277777778,110.455777777778);
        MarkerOptions markerB = new MarkerOptions();
        markerB.position(b);
        markerB.title("Pos 1");
        markerB.snippet("-7.473277777778,110.455777777778");
        markerB.icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_RED));
        myMap.addMarker(markerB);
        
        LatLng c = new LatLng(-7.468388888889,110.451111111111);
        MarkerOptions markerC = new MarkerOptions();
        markerC.position(c);
        markerC.title("Pos 2");
        markerC.snippet("-7.468388888889,110.451111111111");
        markerC.icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_BLUE));
        myMap.addMarker(markerC);
        
        LatLng d = new LatLng(-7.464666666667,110.445305555556);
        MarkerOptions markerD = new MarkerOptions();
        markerD.position(d);
        markerD.title("Sabana I");
        markerD.snippet("-7.464666666667,110.445305555556");
        markerD.icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_CYAN));
        myMap.addMarker(markerD);
        
        LatLng e = new LatLng(-7.460861111111,110.443888888889);
        MarkerOptions markerE = new MarkerOptions();
        markerE.position(e);
        markerE.title("Sabana II");
        markerE.snippet("-7.460861111111.110.443888888889");
        markerE.icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_MAGENTA));
        myMap.addMarker(markerE);
        
        LatLng f = new LatLng(-7.454861111111,110.439805555556);
        MarkerOptions markerF = new MarkerOptions();
        markerF.position(f);
        markerF.title("Puncak");
        markerF.snippet("-7.454861111111,110.439805555556");
