...
public class MerapiJalur extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // addGoogleMap();
        ...
        LatLng a = new LatLng(-7.511944444444,110.453888888889);
        MarkerOptions markerA = new MarkerOptions();
        markerA.position(a);
        markerA.title("Basecamp Barameru");
        markerA.snippet("-7.511944444444,110.453888888889");
        markerA.icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_GREEN));
        myMap.addMarker(markerA);
        
        LatLng b = new LatLng(-7.515833333333,110.452777777778);
        MarkerOptions markerB = new MarkerOptions();
        markerB.position(b);
        markerB.title("New Selo");
        markerB.snippet("-7.515833333333,110.452777777778");
        markerB.icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_RED));
        myMap.addMarker(markerB);
        
        LatLng c = new LatLng(-7.5225,110.451666666667);
        MarkerOptions markerC = new MarkerOptions();
        markerC.position(c);
        markerC.title("Pos 1 Merapi");
        markerC.snippet("-7.5225,110.451666666667");
        markerC.icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_BLUE));
        myMap.addMarker(markerC);
        
        LatLng d = new LatLng(-7.526388888889,110.451111111111);
        MarkerOptions markerD = new MarkerOptions();
        markerD.position(d);
        markerD.title("Pos Batu Belah");
        markerD.snippet("-7.526388888889,110.451111111111");
        markerD.icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_CYAN));
        myMap.addMarker(markerD);
        
        LatLng e = new LatLng(-7.5025,110.755277777778);
        MarkerOptions markerE = new MarkerOptions();
        markerE.position(e);
        markerE.title("Tugu Triangulasi");
        markerE.snippet("-7.5025,110.755277777778");
        markerE.icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_MAGENTA));
        myMap.addMarker(markerE);
        
        LatLng f = new LatLng(-7.54,110.447222222222);
        MarkerOptions markerF = new MarkerOptions();
        markerF.position(f);
        markerF.title("Puncak Merapi");
        markerF.snippet("-7.54,110.447222222222");
